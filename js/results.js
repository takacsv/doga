...
parseCSV = function(content) {
  var csv, f, field, fields, formid, hdr_field, header, i, j, line, lines, ln_flds, resp_id, ret, solutions, type, _i, _j, _k, _len, _len1, _len2;
    ...
    if (lines.length === 1 && !formid) {
      ...
      for (i = _j = 0, _len1 = lines.length; _j < _len1; i = ++_j) {
        ...
        if (ln_flds.length) {
          ...
          ret[resp_id] = {};
          for (j = _k = 0, _len2 = header.length; _k < _len2; j = ++_k) {
            hdr_field = header[j];
